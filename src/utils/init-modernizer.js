// When editing this file, make sure to copy the script from https://modernizr.com/download/
// to "initModernizr" function body

// PLEASE NOTE - all typescript support and linters are disabled
// so don't add any custom code

// After building a new custom script on https://modernizr.com/download/
// Make sure you copy the comment above the "initModernizr" function
// and code in the function, below the "// @ts-ignore" comment
